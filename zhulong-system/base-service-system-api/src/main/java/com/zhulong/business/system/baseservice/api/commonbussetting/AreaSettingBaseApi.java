 ...
 */
public interface AreaSettingBaseApi {

    // url前缀
    String URL_PRE = "/areaSettingBaseApi";
    ...
    AreaSettingDTO getByGuid(@RequestParam("guid") String guid);
    ...
    List<AreaSettingDTO> findByGuidList(@RequestBody List<String> guidList);
    ...
    Pagination<AreaSettingDTO> findPage(@RequestBody AreaSettingQueryDTO queryDTO);
    ...
    List<AreaSettingDTO> findList(@RequestBody AreaSettingQueryDTO queryDTO);
    ...
    void save(@RequestBody AreaSettingDTO dto);
    ...
    AreaSettingDTO update(@RequestBody AreaSettingDTO dto);
