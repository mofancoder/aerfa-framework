 ...
 */
public interface CodeRuleSettingBaseApi {

    // url前缀
    String URL_PRE = "/codeRuleSettingBaseApi";
    ...
    CodeRuleSettingDTO getByGuid(@RequestParam("guid") String guid);
    ...
    List<CodeRuleSettingDTO> findByGuidList(@RequestBody List<String> guidList);
     ...
     */
     ...
     Pagination<CodeRuleSettingDTO> findPage(@RequestBody CodeRuleSettingQueryDTO queryDTO);
      ...
      */
      ...
      void save(@RequestBody CodeRuleSettingDTO dto);
       ...
       */
       ...
       CodeRuleSettingDTO update(@RequestBody CodeRuleSettingDTO dto);
