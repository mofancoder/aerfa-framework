...
*/
public interface CurrencyRateSettingBaseApi {

    //url前缀
    String URL_PRE="/currencyRateSettingBaseApi";
    ...
    */
    ...
    CurrencyRateSettingDTO getByGuid(@RequestParam("guid") String guid);
    ...
    */
    ...
    List<CurrencyRateSettingDTO> findByGuidList(@RequestBody List<String> guidList);
    ...
    */
    ...
    List<CurrencyRateSettingDTO> findList(@RequestBody CurrencyRateSettingQueryDTO queryDTO);
     ...
     */
     ...
     Pagination<CurrencyRateSettingDTO> findPage(@RequestBody CurrencyRateSettingQueryDTO queryDTO);
      ...
      */
      ...
      void save(@RequestBody CurrencyRateSettingDTO dto);
       ...
       */
       ...
       CurrencyRateSettingDTO update(@RequestBody CurrencyRateSettingDTO dto);
